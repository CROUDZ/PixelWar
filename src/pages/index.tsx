...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    const updateScreenSize = () => {
      ...
      if (isMobile && (showOverlayControls || showNavInfo || showPixelCount || showAdminPanel)) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-slate-900 dark:to-gray-800">
      ...
      <main className="relative flex flex-col min-h-[calc(100vh-96px)]">
        {/* Mobile Backdrop */}
        <AnimatePresence>
          {(showMobileSidebar || showOverlayControls || showPixelInfos || showNavInfo || showPixelCount || showAdminPanel) && screenSize.isMobile && (
            <m.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
        ...
        <div className="flex flex-1">
            ...
            {showMobileSidebar && screenSize.isMobile && (
              ...
              >
                <div className="p-6 h-full flex flex-col">
                  <div className="mb-8">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Menu</h2>
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    >
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                        showOverlayControls ? 'bg-blue-500' : 'bg-gradient-to-br from-blue-500 to-cyan-500'
                      }`}>
                        <Settings className="w-5 h-5 text-white" />
                      </div>
                      <div className="flex-1 text-left">
                        <div className="font-semibold">Contrôles Overlay</div>
                        <div className="text-sm opacity-75">Gestion des images</div>
                      </div>
                    </button>
                    ...
                    >
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                        showPixelInfos ? 'bg-green-500' : 'bg-gradient-to-br from-green-500 to-emerald-500'
                      }`}>
                        <BarChart3 className="w-5 h-5 text-white" />
                      </div>
                      <div className="flex-1 text-left">
                        <div className="font-semibold">Infos Pixel</div>
                        <div className="text-sm opacity-75">Détails en temps réel</div>
                      </div>
                    </button>
                    ...
                    >
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                        showNavInfo ? 'bg-purple-500' : 'bg-gradient-to-br from-purple-500 to-pink-500'
                      }`}>
                      ...
                      <div className="flex-1 text-left">
                        ...
                        <div className="text-sm opacity-75">Contrôles de vue</div>
                      </div>
                    </button>
                    ...
                    >
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                        showPixelCount ? 'bg-orange-500' : 'bg-gradient-to-br from-orange-500 to-red-500'
                      }`}>
                        <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex-1 text-left">
                        ...
                        <div className="text-sm opacity-75">Statistiques globales</div>
                      </div>
                    </button>

                    {session?.user?.role === "ADMIN" && session?.user?.twoFA && (
                      <button
                        onClick={() => {
                      ...
                      >
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                          showAdminPanel ? 'bg-red-500' : 'bg-gradient-to-br from-red-500 to-pink-500'
                        }`}>
                          <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="flex-1 text-left">
                          ...
                          <div className="text-sm opacity-75">Outils administrateur</div>
                        </div>
                      </button>
                    )}
                  </div>
          ...
          <div className="flex-1 flex">
            ...
            <AnimatePresence>
              {showOverlayControls && (
                <m.aside
                  initial={{ x: screenSize.isMobile ? "-100%" : "-100%", opacity: 0 }}
                  animate={{ x: 0, opacity: 1 }}
                  exit={{ x: screenSize.isMobile ? "-100%" : "-100%", opacity: 0 }}
                  transition={{ type: "spring", stiffness: 300, damping: 30 }}
                  className={`
                    ${screenSize.isMobile 
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-2 sm:p-4 lg:p-6">
              ...
              >
                ...
                <OverlayImage
                  ...
                  transform={transform}
                  zIndex={20}
                  canvasZoom={canvasApiRef.current?.getZoom?.() ?? canvasNavState.zoom}
                  canvasPan={
              ...
              {screenSize.isMobile && (showNavInfo || showPixelCount || showAdminPanel) && (
                <AnimatePresence>
                  <m.div

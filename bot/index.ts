...
declare module 'discord.js' {
  interface Client {
    commands: Collection<string, { execute: (...args: unknown[]) => void; data: { name: string; description: string } }>;
    buttons: Collection<string, { execute: (...args: unknown[]) => void; data: { label: string; style: string } }>;
